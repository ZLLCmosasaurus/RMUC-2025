...
void Class_Buzzer::Buzzer_SheetListInit(void)
{
  ...
  SheetMusic[BUZZER_DJI_STARTUP_PRIORITY].SetToneList(BUZZER_DJI_STARTUP_PRIORITY_TONELIST[0], BUZZER_DJI_STARTUP_PRIORITY_TONELIST[1], BUZZER_DJI_STARTUP_PRIORITY_NUM);
